...
namespace Pmfst_GameSDK
{
    ...
    public class Zombie:Lik
    {
        ...
        public Zombie(string spriteImage, int posX, int posY,int brzina) : base(spriteImage, posX, posY)
        {
            Brzina = brzina;
        }
    }
       ...
       /* override public int Y
        {
            ...
            set
            {
            //ovi cili dia se izvrsi samo jednom kad rucno namisin u blg y
                if(value>GameOptions.DownEdge && value<GameOptions.UpEdge)
                {
                    this.Active = false;
        ...
        override public int X
        {
            ...
            set
            {
                if (value > GameOptions.RightEdge && value < GameOptions.LeftEdge)
                {
                    this.Active = false;
                    this.SetVisible(false);
                }
        ...
        public Bullet(string spriteImage, int posX, int posY) : base(spriteImage, posX, posY)//obicni konstruktor
        {
            this.Brzina = 10;
            this.Active = false;
            this.SetVisible(false);
